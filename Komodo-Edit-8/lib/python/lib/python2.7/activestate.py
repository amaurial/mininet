#!/usr/bin/env python
# Copyright (c) 2002-2012 ActiveState Software Inc.  All rights reserved.
...
version_info = {'bsddb_ver': None,
 'build_host': 'kobuild-centos5-64',
 'build_num': 6,
 'build_plat_fullname': 'linux2.6-centos5.8-libc6-glibc2.5-libcpp6-x86_64',
 'build_plat_name': 'linux-x86_64',
 'build_time': 'Tue Sep  4 15:56:47 2012',
 'bzip2_ver': (1, 0, 5),
 'compiler': 'gcc',
 'configuration': ['-p', 'komodosilo'],
 'openssl_ver': (0, 9, 8, 'r'),
 'platinfo': {'arch': 'x86_64',
              'distro': 'CentOS',
              'distro_codename': 'Final',
              'distro_desc': 'CentOS release 5.8 (Final)',
              'distro_ver': '5.8',
              'glibc': 'glibc',
              'glibc_ver': '2.5',
              'libc': 'libc6',
              'libcpp': 'libcpp6',
              'lsb_version': ':core-4.0-amd64:core-4.0-ia32:core-4.0-noarch:graphics-4.0-amd64:graphics-4.0-ia32:graphics-4.0-noarch:printing-4.0-amd64:printing-4.0-ia32:printing-4.0-noarch',
              'name': 'linux-x86_64',
              'os': 'linux',
              'os_ver': '2.6.18'},
 'platname': 'linux-x86_64',
 'product_type': 'ActivePython',
 'python_src': ('2.7.3', 'path', 'Python-2.7.3.tgz'),
 'pywin32_build': None,
 'pywin32_src': None,
 'pywin32_ver': None,
 'scm_revision': 'rDEV',
...
compiler_info = """gcc (GCC) 4.1.2 20080704 (Red Hat 4.1.2-52)"""


# Used for Python install relocation.
prefixes = set([
    # Prefix to which extensions were built
    '/home/mininet/Komodo-Edit-8/lib/python',
...
shortest_original_prefix_length = 288
